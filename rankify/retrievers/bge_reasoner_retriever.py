"""
BGE Reasoner Retriever.
- SentenceTransformer-based
Implements the BAAI/bge-reasoner-embed-qwen3-8b-0923 model. 
This retriever is specifically designed for reasoning-intensive tasks, 
using an instruction-aware Qwen3-8B backbone.
"""
...
# BgeReasonerEmbedRetriever Class
